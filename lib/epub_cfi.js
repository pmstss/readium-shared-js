    ...
    EPUBcfi.Generator = {
        ...
        generateMixedRangeComponent: function (rangeStartElement, startOffset, rangeEndElement, endOffset, commonAncestor, classBlacklist, elementBlacklist, idBlacklist) {
            ...
            if (this.validateTextNode(rangeStartElement)) {
                range1ElementType = 3;
            } else if (this.validateElementNode(rangeStartElement)){
                range1ElementType = 1;
            } else {
                throw new EPUBcfi.NodeTypeError(rangeStartElement, "CFI target for generating mixed range is neither a valid text or element node.");
            }

            if (this.validateTextNode(rangeEndElement)) {
                range2ElementType = 3;
            } else if (this.validateElementNode(rangeEndElement)){
                range2ElementType = 1;
            } else {
                throw new EPUBcfi.NodeTypeError(rangeEndElement, "CFI target for generating mixed range is neither a valid text or element node.");
            }
