...
//                } else {
                    ...
                    var rangeInfo = this.getResolvedRangeInfo(rangeStartElement, rangeEndElement);
                ...
                //resolve commonAncestor given if its a commonAncenstorContainer along with start and end containers and not elements
        ...
        generateCharOffsetRangeComponent: function (rangeStartElement, startOffset, rangeEndElement, endOffset, classBlacklist, elementBlacklist, idBlacklist) {
            ...
            if ($(rangeStartElement).parent()[0] === $(rangeEndElement).parent()[0]) {
                ...
                // Create a document range to find the common ancestor
                rangeInfo = this.getResolvedRangeInfo(rangeStartElement, rangeEndElement);
                commonAncestor = rangeInfo.commonAncestor;
        ...
        getResolvedRangeInfo: function (rangeStartElement, rangeEndElement) {
            // Create a document range to find the common ancestor
        ...
        resolveCommonAncestor: function (rangeStartElement, rangeEndElement, commonAncestorContainer) {
            if ($(commonAncestorContainer)[0].nodeType === 3) {
                //text nodes can be commonAncestors in ranges, we don't want that, therefore we get the parent of the ancestor
...
//            }
        ...
        generateRangeCfiComponentFromNode: function (node, nodeType, nodeOffset, isEndNode, differentParents, commonAncestor, classBlacklist, elementBlacklist, idBlacklist) {
            ...
            var cfiPart;
            if (nodeType === 3 && differentParents) {
                // Generate terminating offset and range 1
                offsetStep = this.createCFITextNodeStep($(node), nodeOffset, classBlacklist, elementBlacklist, idBlacklist);
                var $parent = $(node).parent();
                if ($parent[0] !== commonAncestor) {
                    cfiPart = this.createCFIElementSteps($parent, commonAncestor, classBlacklist, elementBlacklist, idBlacklist) + offsetStep;
                } else {
                    cfiPart = offsetStep;
                }
            } else
            if (nodeType === 3) {
                ...
                var childNode = nodeOffset === 0 ? node : $(node)[0].childNodes[nodeOffset];
                if (!childNode) {
                ...
                if (childNode.nodeType === 3) {
                    var charEndOffset= isEndNode ? childNode.length : 0;
