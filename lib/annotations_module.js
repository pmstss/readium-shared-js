...
var EpubAnnotationsModule = function (contentDocumentFrame, bbPageSetView, annotationCSSUrl) {
    ...
    EpubAnnotations.ReflowableAnnotations = Backbone.Model.extend({
        ...
        addHighlight: function (CFI, id, type, styles) {
            ...
            this.annotations.addHighlight(CFI, id, types, styles, selectedElements, startNode,range.startOffset,endNode,range.endOffset, 0, leftAddition);
        ...
        EpubAnnotations.Annotations = Backbone.Model.extend({
            ...
            addHighlight: function (CFI, annotationId, types, styles, highlightedNodes, startNode, startOffset, endNode, endOffset,  offsetTop, offsetLeft) {
                if (!offsetTop) {
